        ...
        if error != nil {
            ...
            do {
                ...
                if (data != nil) {
                    ...
                    print("data Neel->>>\(String(describing: NSString(data: data, encoding: String.Encoding.utf8.rawValue)))-")
...
extension String {
    ...
    */
    ...
    func converDate(_ from:String, _ to:String) -> String {
        if self.count == 0 {//self.characters.count
            return ""
        }
    ...
    var isPhoneNumber: Bool {//self.characters.count
        do {
...
extension UIImageView {
    ...
    func saveImageDocumentDirectory(){
       ...
       // let imageData = UIImage.jpegData(image!, 0.5)
        let imageData = UIImage.jpegData(image ?? "NNN")
...
class PredefinedConstants: NSObject {
    ...
    static let twitter_Consumer_API_Key = "NJbqaly91F9hRE4W4Qaq2XQN5"
    static let twitter_Consumer_Secret_Key = "okxGOVe97lmtF0H1ezX0B8dTDUedoaxIirvAqV9JUNaaR0lDzcs"
    
    
   static let Google_CLIENT_ID =  "256993710117-hdt590av9hulc07cjr5jokp307v86neb.apps.googleusercontent.com" //new 5 sept 

    static let Google_CLIENT_ID_reverse =  "com.googleusercontent.apps.256993710117-hdt590av9hulc07cjr5jokp307v86neb"
